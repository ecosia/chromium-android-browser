...
class EyeoDocumentInfo final
 ...
 public:
  ...
  // Whether the document has matched any Acceptable Ads filters.
  bool HasMatchedAcceptableAds() const;
  void SetMatchedAcceptableAds();

  // Whether navigation to this main-frame document has been counted for stats.
  bool IsNavigationCounted() const;
  void SetNavigationCounted();
 ...
 private:
  ...
  bool matched_acceptable_ads_ = false;
  bool is_navigation_counted_ = false;
