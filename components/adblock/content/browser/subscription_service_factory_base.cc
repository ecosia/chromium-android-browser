...
SubscriptionServiceFactoryBase::SubscriptionServiceFactoryBase()
    : BrowserContextKeyedServiceFactory(
          "AdblockSubscriptionService",
          BrowserContextDependencyManager::GetInstance()) {}

SubscriptionServiceFactoryBase::~SubscriptionServiceFactoryBase() = default;

KeyedService* SubscriptionServiceFactoryBase::BuildServiceInstanceFor(
  ...
  if (persisted_configs.empty()) {
    ...
    CheckAndRunFirstRunLogic(prefs, GetLocale(),
                             adblock_filtering_configuration);
...
SubscriptionServiceFactoryBase::ConvertCustomFilters(
...
void SubscriptionServiceFactoryBase::RegisterProfilePrefs(
...
// static
void SubscriptionServiceFactoryBase::SetUpdateCheckAndDelayIntervalsForTesting(
