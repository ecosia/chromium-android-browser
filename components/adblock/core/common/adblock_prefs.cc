...
const char kTelemetryAcceptableAdsStats[] =
    "adblock.telemetry.acceptable_ads_stats";
...
void RegisterTelemetryPrefs(PrefRegistrySimple* registry) {
  ...
  registry->RegisterDictionaryPref(kTelemetryAcceptableAdsStats);
}
