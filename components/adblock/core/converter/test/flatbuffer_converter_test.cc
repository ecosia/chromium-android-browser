...
TEST_F(AdblockFlatbufferConverterTest, RewriteEmpty) {
  auto subscriptions = ConvertAndLoadRules(R"(
...
TEST_F(AdblockFlatbufferConverterTest, RewriteDomain) {
  auto subscriptions = ConvertAndLoadRules(R"(
...
TEST_F(AdblockFlatbufferConverterTest, RewriteFirstPartyDomainNotMatching) {
  auto subscriptions = ConvertAndLoadRules(R"(
     ||adform.net/banners/scripts/adx.css$rewrite=abp-resource:blank-css,~third-party
    )");
  EXPECT_TRUE(subscriptions
...
TEST_F(AdblockFlatbufferConverterTest, RewriteFirstPartyAndDomain) {
  auto subscriptions = ConvertAndLoadRules(R"(
...
TEST_F(AdblockFlatbufferConverterTest, RewriteAllowedFilter) {
  auto subscriptions = ConvertAndLoadRules(R"(
     @@||adform.net/banners/scripts/adx.css$domain=delfi.lt,rewrite=abp-resource:blank-css
    )");
  EXPECT_EQ(*subscriptions
...
// See DPD-1913
TEST_F(AdblockFlatbufferConverterTest, InvalidFilterDoesNotCrashParser) {
  auto subscription = ConvertAndLoadRules(R"(
    ||
    |
  )");
...
// See DPD-1978
TEST_F(AdblockFlatbufferConverterTest, DomainSpecificSinglePipe) {
  auto subscription = ConvertAndLoadRules(R"(
    |$domain=example.com
  )");
...
// See DPD-1978
TEST_F(AdblockFlatbufferConverterTest, DomainSpecificSinglePipeWithWildcard) {
  auto subscription = ConvertAndLoadRules(R"(
    |*$domain=example.com
  )");
  EXPECT_TRUE(subscription->HasUrlFilter(GURL("http://example.com/content.jpg"),
...
// See DPD-1978
TEST_F(AdblockFlatbufferConverterTest, DomainSpecificDoublePipe) {
  auto subscription = ConvertAndLoadRules(R"(
    ||$domain=example.com
  )");
  EXPECT_TRUE(subscription->HasUrlFilter(GURL("http://example.com/content.jpg"),
...
// See DPD-1978
TEST_F(AdblockFlatbufferConverterTest, DomainSpecificDoublePipeWithWildcard) {
  auto subscription = ConvertAndLoadRules(R"(
    ||*$domain=example.com
  )");
  EXPECT_TRUE(subscription->HasUrlFilter(GURL("http://example.com/content.jpg"),
