...
base::Value::Dict ReadFromPrefs(PrefService* pref_service,
  ...
  const auto& all_configurations =
      pref_service
          ->GetValue(filtering_configuration::prefs::kConfigurationsPrefsPath)
          .GetDict();
...
void StoreToPrefs(const base::Value::Dict& configuration,
  ...
  static std::string kConfigurationsPrefsPathString(
      filtering_configuration::prefs::kConfigurationsPrefsPath);
...
void PersistentFilteringConfiguration::RegisterProfilePrefs(
  ...
  registry->RegisterDictionaryPref(
      std::string(filtering_configuration::prefs::kConfigurationsPrefsPath));
}
