...
public class ResourceFilteringCounters {
    ...
    public static class ResourceInfo {
        // TODO: Make members private after removing AdblockCounters
        ...
        ResourceInfo(final String requestUrl, final List<String> parentFrameUrls,
                final String subscriptionUrl, final String configurationName, final int contentType,
                final int tabId) {
        ...
        /**
         * @return The resource content type. See enum ContentType in
        ...
        public String toString() {
            return "mRequestUrl: " + mRequestUrl + ", mParentFrameUrls: "
                    ...
                    + ", mConfigurationName:" + mConfigurationName
                    + ", mContentType: " + mContentType.getValue() + ", mTabId: " + mTabId;
        }
    }
}
