...
TOP_VANILLA_COMMIT=$(git rev-parse --short origin/chromium-${CHROMIUM_TAG}-vanilla-automated~1)
...
components/adblock/android/README.md
components/adblock/android/adblock_strings.grd
components/adblock/android/java/res/drawable-*
components/adblock/android/java/res/layout/
components/adblock/android/java/res/xml/
components/adblock/android/java/src/org/chromium/components/adblock/settings/
chrome/browser/adblock/android/javatests/src/org/chromium/chrome/browser/adblock/AdblockFilterFragmentTest.java
chrome/browser/adblock/android/javatests/src/org/chromium/chrome/browser/adblock/AdblockPopupInfoBarTest.java
chrome/browser/adblock/android/javatests/src/org/chromium/chrome/browser/adblock/AdblockPopupMessageTest.java
components/adblock/android/translations/
"

ANDROID_UI_SHARED_FILES="
chrome/browser/adblock/android/BUILD.gn
chrome/android/BUILD.gn
components/adblock/android/BUILD.gn
"
...
sed -i '/Extension API module start/,/Extension API module end/d' chrome/test/BUILD.gn
git add chrome/test/BUILD.gn
