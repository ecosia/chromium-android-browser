...
if __name__ == '__main__':
    ...
    parser.add_argument('input_dir', help='directory where dependencies.jst can be found')
    parser.add_argument('output_file', help='output file where to copy content parsed from dependencies.jst')
