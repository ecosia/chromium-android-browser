...
public class ResourceClassificationNotifierTest {
    ...
    public void setUp() throws TimeoutException {
        TestThreadUtils.runOnUiThreadBlocking(() -> {
            ...
            AdblockController.getInstance().addOnAdBlockedObserver(mAdBlockedObserver);
            ResourceClassificationNotifier.getInstance().addResourceFilteringObserver(
                    mResourceFilteringObserver);
    ...
    public void pageAllowed() throws Exception {
        TestThreadUtils.runOnUiThreadBlocking(() -> {
            ...
            AdblockController.getInstance().addAllowedDomain("test.org");
            mHelper.notifyCalled();
        });
        mHelper.waitForCallback(0, 1, 10, TimeUnit.SECONDS);
        loadTestUrl();
        ...
        Assert.assertTrue(mAdBlockedObserver.isPageAllowed("test.org"));
