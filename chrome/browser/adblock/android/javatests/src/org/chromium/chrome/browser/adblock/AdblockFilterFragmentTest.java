    ...
    public void testAutoInstalledFilterListsCheckbox() throws MalformedURLException {
        ...
        ThreadUtils.runOnUiThreadBlocking(
                () -> {
                    ...
                    final Map<String, Pair<Boolean, Boolean>> expectations =
                            new HashMap<>() {
                                {
                                    put(autoInstalledUrl, new Pair<>(true, false));
                                    put(manuallyInstalledUrl, new Pair<>(true, true));
                                    put(recommendedUrl, new Pair<>(false, true));
                                }
                            };
