...
class EyeoFilteringPrivateAddFilterListFunction
    : public ExtensionFunction {
 public:
  DECLARE_EXTENSION_FUNCTION("eyeoFilteringPrivate.addFilterList",
                             UNKNOWN)
...
class EyeoFilteringPrivateRemoveFilterListFunction
    : public ExtensionFunction {
 public:
  DECLARE_EXTENSION_FUNCTION("eyeoFilteringPrivate.removeFilterList",
                             UNKNOWN)
