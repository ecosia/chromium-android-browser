...
EyeoFilteringPrivateAddFilterListFunction::Run() {
  absl::optional<api::eyeo_filtering_private::AddFilterList::Params>
      params(api::eyeo_filtering_private::AddFilterList::Params::Create(
          args()));
  EXTENSION_FUNCTION_VALIDATE(params);
  auto* configuration =
      FindFilteringConfiguration(browser_context(), params->configuration);
...
EyeoFilteringPrivateRemoveFilterListFunction::Run() {
  absl::optional<api::eyeo_filtering_private::RemoveFilterList::Params>
      params(api::eyeo_filtering_private::RemoveFilterList::Params::
                 Create(args()));
  EXTENSION_FUNCTION_VALIDATE(params);
  auto* configuration =
      FindFilteringConfiguration(browser_context(), params->configuration);
