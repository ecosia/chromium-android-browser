...
public abstract class ChromeFeatureList {
    ...
    public static boolean isEnabled(String featureName) {
        ...
        if (featureName.equals(ChromeFeatureList.PRIVACY_SANDBOX_SETTINGS_4)
        ...
        if (featureName.equals(ChromeFeatureList.WEB_FEED_ONBOARDING)
        || featureName.equals(ChromeFeatureList.WEB_FEED_AWARENESS)
        || featureName.equals(ChromeFeatureList.WEB_FEED_SORT)) {
            return false;
        }
