...
public class Requests {
    ...
    public String postEmptyBody(String requestUrl, HashMap<String, String> requestHeaders) throws IOException {
        InputStream inputStream = null;
    ...
    public String postStringBody(String requestUrl, String body, HashMap<String, String> requestHeaders) throws IOException {
        InputStream inputStream = null;
