...
import org.chromium.chrome.browser.adblock.settings.EcosiaAdblockPreferences;
...
public class EcosiaToolbarTablet extends ToolbarTablet {
    ...
    public void onNativeLibraryReady() {
        ...
        mFilteringConfiguration = FilteringConfiguration.createConfiguration("adblock", ProfileManager.getLastUsedRegularProfile());
    }
    ...
    private void updateAdblockIcon() {
        ...
        if (mFilteringConfiguration.isEnabled()) {
    ...
    @Override
    public void onTintChanged(ColorStateList tint,
                              ColorStateList activityFocusTint,
                              @BrandedColorScheme int brandedColorScheme) {
        super.onTintChanged(tint,
                activityFocusTint, brandedColorScheme);
        if (mAdblockButton != null) {
    ...
    private boolean adblockerStatusChanged() {
        ...
        try {
            currentState = mFilteringConfiguration.isEnabled();
        } catch (Exception e) {
