...
import static org.ecosia.referrals.Referrals.ClaimError.ALREADY_CLAIMED;
import static org.ecosia.referrals.Referrals.ClaimError.INVALID_LINK;
import static org.ecosia.referrals.Referrals.ClaimError.NETWORK_ERROR;
...
public class EcosiaNewTabPageView extends FrameLayout {
    ...
    private void addPersonalImpactCard() {
        ...
        // Referrals
        if (Referrals.getInstance(mContext).isReferralsFeatureEnabled()) {
