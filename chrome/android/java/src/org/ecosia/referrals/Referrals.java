...
public class Referrals {
    ...
    public boolean isReferralsFeatureEnabled() {
        return mUnleash.isEnabled(Toggle.Name.REFERRALS) || storedComputedClaimsCount() > 0 || isValidReferralCode(getInstallReferrer());
    }
