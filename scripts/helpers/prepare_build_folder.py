...
def _args(build_type, cpu_type, version_name, version_code, android_keystore_password, appcenter_id, abp_telemetry_token, cloudflare_client_id, cloudflare_client_secret, facebook_app_id):
    common_args = ""\
        ...
        + f"facebook_app_id = \\\"{facebook_app_id}\\\" " \
...
if __name__ == '__main__':
    ...
    if not facebook_app_id:
        print(f"{yellow_color}Warning:{no_color} Didn't find the FACEBOOK_APP_ID var in your env.")
        facebook_app_id = "NOT_SET"
    ...
    gn_args = _args(args.target, args.cpu, args.version_name, args.version_code, android_keystore_password, appcenter_id, abp_telemetry_token, cloudflare_client_id, cloudflare_client_secret, facebook_app_id)
