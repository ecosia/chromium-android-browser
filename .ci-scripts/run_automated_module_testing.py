...
try:
  ...
  origin.push(EYEO_RELEASE_TAG + "-base-module-branch", force=True,
              o=["ci.variable=PIPELINE_TYPE=default", "ci.variable=RUN_FOR_MODULE=true"])
  ...
  origin.push(EYEO_RELEASE_TAG + "-base-webview-module-branch", force=True,
              o=["ci.variable=PIPELINE_TYPE=default", "ci.variable=RUN_FOR_WEBVIEW_MODULE=true", "ci.variable=RUN_FOR_MODULE=true"])
except:
