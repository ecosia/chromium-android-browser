...
try:
    ...
    for branch in modules_branches_to_create:
        if any(
                local_branch.name.endswith(branch)
    ...
    origin.push(EYEO_RELEASE_TAG + "-base-chrome-module-branch",
                force=True,
                o=[
                    "ci.variable=PIPELINE_TYPE=custom",
                    "ci.variable=RUN_FOR_MODULE=true",
    ...
    repo.git.checkout(VANILLA_BRANCH)
    repo.git.checkout(
        "-b", EYEO_RELEASE_TAG + "-base-chrome-android-api-module-branch")
    repo.git.am("eyeo_modules/base.patch")
    repo.git.am("eyeo_modules/chrome_integration.patch")
    repo.git.am("eyeo_modules/android_api.patch")
    origin.push(EYEO_RELEASE_TAG + "-base-chrome-android-api-module-branch",
                force=True,
                o=[
                    "ci.variable=PIPELINE_TYPE=custom",
                    "ci.variable=RUN_FOR_MODULE=true",
    ...
    repo.git.checkout(VANILLA_BRANCH)
    repo.git.checkout(
        "-b", EYEO_RELEASE_TAG + "-base-chrome-android-settings-module-branch")
    repo.git.am("eyeo_modules/base.patch")
    repo.git.am("eyeo_modules/chrome_integration.patch")
    repo.git.am("eyeo_modules/android_api.patch")
    repo.git.am("eyeo_modules/android_settings.patch")
    origin.push(EYEO_RELEASE_TAG +
                "-base-chrome-android-settings-module-branch",
                force=True,
                o=[
                    "ci.variable=PIPELINE_TYPE=custom",
                    "ci.variable=RUN_FOR_MODULE=true",
    ...
    origin.push(EYEO_RELEASE_TAG + "-base-chrome-desktop-module-branch",
                force=True,
                o=[
                    "ci.variable=PIPELINE_TYPE=custom",
                    "ci.variable=RUN_FOR_MODULE=true",
    ...
    origin.push(EYEO_RELEASE_TAG + "-base-webview-module-branch",
                force=True,
                o=[
                    "ci.variable=PIPELINE_TYPE=custom",
                    "ci.variable=RUN_FOR_MODULE=true",
